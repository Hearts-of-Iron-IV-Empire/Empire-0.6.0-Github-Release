...
NMilitary = {
	...
	SUPPLY_GRACE = 48,							   -- troops always carry 3 --> 2 days of food and supply
	SUPPLY_GRACE_MAX_REDUCE_PER_HOUR = 4,          -- supply grace is not decreased instantly when it is buffed temporarily and buff is removed
	SUPPLY_ORG_MAX_CAP = 0.35,                     -- Max organization is factored by this if completely out of supply
	MAX_OUT_OF_SUPPLY_DAYS = 10, 				   -- how many days of shitty supply until max penalty achieved
	OUT_OF_SUPPLY_ATTRITION = 0.60,                 -- max attrition when out of supply
...
NAI = {
	...
	DEPLOY_MIN_TRAINING_SURRENDER_FACTOR = 0.3,     -- Required percentage of training (1.0 = 100%) for AI to deploy unit in wartime while surrender progress is higher than 0
	DEPLOY_MIN_EQUIPMENT_SURRENDER_FACTOR = 0.3,   -- Required percentage of equipment (1.0 = 100%) for AI to deploy unit in wartime while surrender progress is higher than 0
	DEPLOY_MIN_TRAINING_PEACE_FACTOR = 0.88,        -- Required percentage of training (1.0 = 100%) for AI to deploy unit in peacetime
	DEPLOY_MIN_EQUIPMENT_PEACE_FACTOR = 0.88,       -- Required percentage of equipment (1.0 = 100%) for AI to deploy unit in peacetime
	...
	DEPLOY_MIN_EQUIPMENT_CAP_DEPLOY_FACTOR = 0.6,  -- If training is capped by equipment deficit and we have reached that cap, deploy unit anyway if percentage is above this (reinforce in field instead).
...
NSupply = {
	...
	CAPITAL_SUPPLY_BASE = 2.5, -- base supply for capital
